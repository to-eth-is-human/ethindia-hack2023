      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-12 lg:col-span-7  ">
            <div className="mb-2">
            <Link href="/">
            <h1 className="text-md font-extrabold leading-tighter tracking-tighter">DAppXchange BoardSuite</h1>
            </Link>
            </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; DAppXchange BoardSuite. All rights reserved.</div>
