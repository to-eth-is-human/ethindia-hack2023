...
export const ethNetworkRPC = process.env.ETH_NETWORK_RPC || 'https://bsc-dataseed.binance.org' ;
...
export const OneInchTokenAmount = '500000000000';

export const network = NetworkEnum.BINANCE; 